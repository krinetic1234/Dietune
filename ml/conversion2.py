def convert(weight, height, age, sex, fitness_goal, diet_goal, activity_goal):
    ...
    carbs = abs(int((cal_intake - (protein_cal_g * protein + fat_cal_g * fat)) / carbs_cal_g))
    return [cal_intake, protein, fat, carbs]
...
# print(convert(160, 71, 18, "M", "Maintenance", "Low-Carb", "None: Desk Job etc."))